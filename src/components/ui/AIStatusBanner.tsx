...
export function AIStatusBanner() {
  ...
  return (
    <div className="bg-primary-light border-b border-primary border-opacity-20">
      <div className="max-w-7xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between flex-wrap">
          <div className="w-0 flex-1 flex items-center">
            <span className="flex p-2 rounded-lg bg-white bg-opacity-50">
              <svg className="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="flex-shrink-0 order-2 mt-0 w-auto">
            <button
              ...
              className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md text-sm font-medium text-primary bg-white hover:bg-opacity-90 transition-all duration-150"
            >
        ...
        {expanded && (
          <div className="mt-2 pt-2 border-t border-primary border-opacity-20">

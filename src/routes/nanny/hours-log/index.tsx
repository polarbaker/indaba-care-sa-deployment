...
import { HoursLogPanel } from "~/components/nanny/HoursLogPanel";
...
export const Route = createFileRoute("/nanny/hours-log/")({
  component: NannyHoursLog,
});

function NannyHoursLog() {
  ...
  return (
    ...
    >
      <HoursLogPanel onAddHours={handleOpenModal} />

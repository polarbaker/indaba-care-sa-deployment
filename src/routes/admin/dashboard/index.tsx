            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  ...
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">
                      {statsLoading ? "..." : stats.pendingFlags}
                    </div>
                  </dd>
                </div>
              </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  ...
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">
                      {statsLoading ? "..." : stats.observations}
                    </div>
                  </dd>
                </div>
              </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  ...
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">
                      {statsLoading ? "..." : stats.certifications}
                    </div>
                  </dd>
                </div>
              </div>
                          ...
                          <div>
                            <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white ${
                              activity.type === 'user_created' 
                                ? 'bg-green-500' 
                                : activity.type === 'observation_created'
                                  ? 'bg-yellow-500'
                                  : activity.type === 'content_flagged'
                                    ? 'bg-red-500'
                                    : activity.type === 'certification_added'
                                      ? 'bg-indigo-500'
                                      : 'bg-gray-500'
                            }`}>
                              {activity.type === 'user_created' && (
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Link to="/admin/moderation/">
                ...
                >
                  ...
                  {stats.pendingFlags > 0 ? `Review Flags (${stats.pendingFlags})` : "Moderation Queue"}
                </Button>
              </Link>

...
type SettingsTab = "security" | "notifications" | "privacy" | "sync" | "system";
...
function Settings() {
  ...
  // Fetch user data to get the latest settings
  const { 
    data: userData, 
  ...
  // Fetch assigned children for message composer
            ...
            <>
              ...
              {activeTab === "notifications" && (
                <NotificationSettings 
                  initialSettings={userData?.notificationSettings}
                  onSettingsUpdated={() => refetchUser()}
                />
              )}
              ...
              {activeTab === "privacy" && (
                <PrivacySettings 
                  initialSettings={{
                    profileVisibility: userData?.profileVisibility || "connected",
